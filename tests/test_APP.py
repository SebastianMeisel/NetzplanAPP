...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Projekt_Ohne_Ressourcen_und_ID.xlsx",
            "Spalte &#39;ID&#39; fehlt in der Tabelle &#39;Projekt&#39;!",
        ),
        (
            "Projekt_Ohne_Ressourcen_und_ID_Dauer.xlsx",
            "Spalte &#39;ID&#39; fehlt in der Tabelle &#39;Projekt&#39;!",
        ),
        (
            "Projekt_Ohne_Projekt.xlsx",
            "Tabelle &#39;Projekt&#39; fehlt oder hat den falschen Namen",
        ),
        (
            "Ressourcen_Ohne_ID.xlsx",
            "Spalte &#39;ID&#39; fehlt in der Tabelle &#39;Ressourcen&#39;!",
        ),
    ],
)
